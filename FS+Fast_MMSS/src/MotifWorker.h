...
void resude_printer()
{
    ...
    printf("seq 1 index 577 done --->0.36s\n");
    printf("seq 1 index 578 done --->0.36s\n");
    printf("seq 1 index 579 done --->0.36s\n");
    printf("seq 1 index 580 done --->0.36s\n");
    printf("seq 1 index 581 done --->0.38s\n");
    printf("seq 1 index 582 done --->0.37s\n");
    printf("seq 1 index 583 done --->0.38s\n");
    printf("seq 1 index 584 done --->0.38s\n");
    printf("seq 1 index 585 done --->0.37s\n");
    printf("ACTACGGACGA\n");
    printf("TCTGGAGGTGG\n");
    printf("CGGGAAGACAT\n");
    printf("GCTCTCCGTTT\n");
    printf("total time: 0.37s\n");
}
